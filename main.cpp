...
int main()
{
    ...
    while (window.isOpen())
    {
        ...
        while (window.pollEvent(event))
        {
            ...
            {
                window.close();
                cout<<"Usted Apreto ESC y se cerro el Programa ";
            }
        ...
        {
            texturep5.loadFromFile(pila5.top()); //a la textura de la pila 3 se le asigna el nuevo top de la pila 3
            texturep6.loadFromFile(pila6.top()); //a la textura de la pila 4 se le asigna el nuevo top de la pila 4
        }
